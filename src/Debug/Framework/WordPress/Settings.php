...
class Settings extends AbstractComponent implements AssetProviderInterface, SubscriberInterface
{
    ...
    const GROUP_NAME = 'phpdebugconsole';

    const PAGE_SLUG_NAME = 'phpdebugconsole';
    ...
    public function onBootstrap(Event $event)
    {
        ...
        \add_filter('plugin_action_links_' . $this->cfg['pluginFile'], [$this, 'pluginActionLinks'], 10, 4);
    }
    ...
    public function outputSettingsPage()
    {
        ...
        echo '<h2>PHPDebugConsole Settings</h2>' . "\n";
