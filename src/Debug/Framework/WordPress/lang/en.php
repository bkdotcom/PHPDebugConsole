...
return array(
    ...
    'settings.control.enableProfiling.describedBy' => 'If DebugConsoleForPhp is collecting data <b>AND</b> this option is enabled, then we will set {declareTicks}<br /><b>Only enable this when needed</b>',
    'settings.control.enableProfiling.option.on' => 'Enable DebugConsoleForPhp\'s <a target="_blank" href="https://bradkent.com/php/debug#methodProfile">profile method</a>',
    ...
    'settings.description' => 'Debug Console for PHP Settings',
