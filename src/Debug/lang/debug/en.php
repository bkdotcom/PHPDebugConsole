...
return array(
    ...
    'db.limit-exceeded' => 'Limit exceeded',
    'db.row-count' => 'rowCount',
    'db.server-info' => 'Server info',
    'db.slow-queries' => 'Slow queries',
    ...
    'object.inherited-from' => 'Inherited from',
    ...
    'string.binary-not-collected' => 'Binary data not collected',
    'string.more-bytes' => '{bytes} more bytes (not logged)',
