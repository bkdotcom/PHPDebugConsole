    ...
    public function testHead()
    {
        ...
        $this->outputTest(array(
            'html' => function ($htmlActual) {
                $expect = '%A<li class="m_group" data-channel="general.curl" data-icon="fa fa-exchange">
                    ...
                    <ul class="group-body">
                        ...
                        <li class="m_time" data-channel="general.curl"><span class="no-quotes t_string">time: %f %s</span></li>
                        <li class="m_log" data-channel="general.curl"><span class="no-quotes t_string">response headers</span> = <span class="t_string">HTTP/1.1 200 OK%a</span></li>
                        <li class="m_log" data-channel="general.curl"><span class="no-quotes t_string">response body</span> = <span class="t_string">CURLOPT_NOBODY</span></li>
                    </ul>
                </li>%A';
                // \bdk\Debug::varDump('expect', $expect);
                // \bdk\Debug::varDump('actual', $htmlActual);
                $this->assertStringMatchesFormatNormalized($expect, $htmlActual);
            },
        ));
    }
