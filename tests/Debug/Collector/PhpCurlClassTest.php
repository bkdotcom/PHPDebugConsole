        ...
        $this->outputTest(array(
            'html' => '<li class="expanded m_group" data-channel="general.Curl" data-icon="fa fa-exchange">
                    ...
                    <ul class="group-body">
                        ...
                        <li class="m_warn" data-channel="general.Curl" data-detect-files="true" data-file="' . __FILE__ . '" data-line="%d"><span class="t_int">%d</span>, <span class="t_string">Unsupported protocol%A: Unsupported HTTP version in response</span></li>
                        <li class="m_time" data-channel="general.Curl"><span class="no-quotes t_string">time: %f %s</span></li>
