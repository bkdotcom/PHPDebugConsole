                            ...
                            <td class="groupByInheritance t_object" data-accessible="public"><span class="t_identifier" data-type-more="className"><span class="classname">Closure</span></span>
                                <dl class="object-inner">
                                    ...
                                    . (PHP_VERSION_ID >= 80500
                                        ? "\n" . '<dd class="isStatic method public"><span class="t_modifier_public">public</span> <span class="t_modifier_static">static</span> <span class="t_identifier">getCurrent</span><span class="t_punct">(</span><span class="t_punct">)</span><span class="t_punct t_colon">:</span> <span class="t_type"><span class="classname">Closure</span></span></dd>'
                                        : '') . '
                                </dl>
                            </td>
                        </tr>
