...
<dt class="properties">properties</dt>
    <dd class="property protected-set public"><span class="t_modifier_public">public</span> <span class="t_modifier_protected-set">protected(set)</span> <span class="t_punct">?</span><span class="t_type">string</span> <span class="no-quotes t_identifier t_string">name</span></dd>
    ...
    <dd class="' . (PHP_VERSION_ID >= 80400 ? 'isFinal ' : '') . 'private-set property protected">' . (PHP_VERSION_ID >= 80400 ? '<span class="t_modifier_final">final</span> ' : '') . '<span class="t_modifier_protected">protected</span> <span class="t_modifier_private-set">private(set)</span> <span class="t_punct">?</span><span class="t_type">int</span> <span class="no-quotes t_identifier t_string">age</span></dd>
