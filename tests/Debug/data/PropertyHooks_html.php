...
<dd class="getHook property public setHook"><span class="t_modifier_public">public</span> <span class="t_punct">?</span><span class="t_type">string</span> <span class="no-quotes t_identifier t_string">backedGetAndSet</span></dd>
<dd class="getHook property public"><span class="t_modifier_public">public</span> <span class="t_punct">?</span><span class="t_type">string</span> <span class="no-quotes t_identifier t_string">backedGetOnly</span></dd>
<dd class="property public setHook"><span class="t_modifier_public">public</span> <span class="t_punct">?</span><span class="t_type">string</span> <span class="no-quotes t_identifier t_string">backedSetOnly</span></dd>
