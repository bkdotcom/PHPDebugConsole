                ...
                array(
                    'html' => function ($str) {
                        ...
                        $this->assertContains(implode("\n", array(
                            ...
                            '<dd class="private-ancestor property private"><span class="t_modifier_private">private</span> (<i class="classname"><span class="namespace">bdk\DebugTest\</span>TestBase</i>) <span class="t_identifier">testBasePrivate</span> <span class="t_operator">=</span> <span class="t_string">defined in TestBase (private)</span></dd>',
